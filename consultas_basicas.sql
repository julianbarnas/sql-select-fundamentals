...
-- Usar * tiene sentido cuando recién conocés la tabla y necesitás ver su estructura completa.
-- No conviene en producción: trae más columnas de las que realmente necesitamos,
-- generando problemas innecesarios de rendimiento y mantenibilidad.
SELECT * FROM sales;
